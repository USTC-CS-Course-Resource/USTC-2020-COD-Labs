...
HD_PWD='D:/VivadoProject/COD/Lab2/Lab2_single/Lab2_single.runs/blk_mem_gen_16x8_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log blk_mem_gen_16x8.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source blk_mem_gen_16x8.tcl

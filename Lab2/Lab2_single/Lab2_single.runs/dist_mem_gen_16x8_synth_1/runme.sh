...
HD_PWD='D:/VivadoProject/COD/Lab2/Lab2_single/Lab2_single.runs/dist_mem_gen_16x8_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dist_mem_gen_16x8.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dist_mem_gen_16x8.tcl

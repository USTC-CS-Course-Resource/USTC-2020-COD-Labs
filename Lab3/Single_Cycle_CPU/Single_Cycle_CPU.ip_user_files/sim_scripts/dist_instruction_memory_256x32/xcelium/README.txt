...
#
# Generated by export_simulation on Fri May 08 13:32:52 +0800 2020
#
################################################################################
...
./dist_instruction_memory_256x32.sh
...
'-reset_run' switch to the './dist_instruction_memory_256x32.sh' script.

./dist_instruction_memory_256x32.sh -reset_run
...
./dist_instruction_memory_256x32.sh -noclean_files

For more information on the script, please type './dist_instruction_memory_256x32.sh -help'.

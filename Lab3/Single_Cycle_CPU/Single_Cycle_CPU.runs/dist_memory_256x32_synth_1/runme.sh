...
HD_PWD='D:/VivadoProject/COD/Lab3/Single_Cycle_CPU/Single_Cycle_CPU.runs/dist_memory_256x32_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dist_memory_256x32.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dist_memory_256x32.tcl

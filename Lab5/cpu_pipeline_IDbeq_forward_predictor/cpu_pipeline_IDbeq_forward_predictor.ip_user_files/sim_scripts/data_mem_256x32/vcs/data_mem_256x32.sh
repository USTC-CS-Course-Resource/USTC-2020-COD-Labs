...
compile()
{
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k \
    "$ref_dir/../../../../cpu_pipeline_IDbeq_forward_predictor.srcs/sources_1/ip/data_mem_256x32/sim/data_mem_256x32.v" \
  2>&1 | tee -a vlogan.log
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.data_mem_256x32 xil_defaultlib.glbl -o data_mem_256x32_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./data_mem_256x32_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key data_mem_256x32_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log 64 AN.DB csrc data_mem_256x32_simv.daidir)

...
#
# Generated by Vivado on Wed Jun 03 18:48:10 +0800 2020
...
elaborate()
{
  xelab --relax --debug typical --mt auto -L dist_mem_gen_v8_0_13 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot data_mem_256x32 xil_defaultlib.data_mem_256x32 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim data_mem_256x32 -key {Behavioral:sim_1:Functional:data_mem_256x32} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb data_mem_256x32.wdb xsim.dir)

...
--               D:/VivadoProject/COD/Lab5/cpu_pipeline_with_branch_predictor/cpu_pipeline_with_branch_predictor.srcs/sources_1/ip/instr_mem_256x32/instr_mem_256x32_sim_netlist.vhdl
...
begin
  ...
  spo(12 downto 11) <= \^spo\(5 downto 4);
  spo(10) <= \^spo\(4);
  spo(9) <= \^spo\(4);
  spo(8) <= \^spo\(4);
  spo(7) <= \^spo\(4);
